(function () {
  ...
  var providerInfo = {
    nous: {
      ...
      modelHint: "Common: Hermes-4-70B, Hermes-4-405B. See portal.nousresearch.com for the full list.",
    ...
    openai: {
      ...
      modelHint: "Common: gpt-5.5, gpt-5.5-pro, gpt-5.4-mini, o4-mini",
      hermesSelect: "OpenAI",
    },
    anthropic: {
      name: "Anthropic",
      ...
      modelHint: "Common: claude-opus-4-7, claude-sonnet-4-6, claude-haiku-4-5",
    ...
    grok: {
      ...
      modelHint: "grok-4.3 is the headline model on the OAuth path (1M-token context).",
      hermesSelect: "xAI Grok OAuth (SuperGrok Subscription)",
    },
  };
  ...
  window.selectProvider = function (provider) {
    ...
    if (providerInfo[provider]) {
      ...
      mg.style.display = info.oauth ? "none" : "block";
  ...
  function generateCommands() {
    ...
    var regPrompt =
      ...
      'On success the account becomes active. The key_fingerprint is non-secret (just the last 6 chars); requiring it is the safety net \u2014 if you cannot produce it you never saved the key, and the pending account simply expires after ~15 minutes instead of stranding you with an account you cannot use.';
